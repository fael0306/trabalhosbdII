...
VALUES 
  ...
  (
    ...
    '1935-06-03', 
    'Emilio Mira y Lopez', 
    'Percepção dos transtornos mentais da época.', 
    1
  ), 
  (
  ...
  (
    ...
    '1988-03-09', 
    'Isabel Adrados', 
    'Explanação sobre questões da infância.', 
    3
  ), 
  (
  ...
  (
    ...
    '1982-08-08', 
    'Isabel Adrados', 
    'Instrução da atuação do psicólogo frente a diagnósticos.', 
    3
  ), 
  (
    'Eliezer Schneider', 
    ...
    'Coleção: Pioneiros da Psicologia Brasileira', 
    4
  ), 
  (
  ...
  (
    ...
    '1971-01-31', 
    'Jornal do Brasil', 
    'Palestra de Eliezer Schneider sobre conflito de gerações.', 
    4
  ), 
  (
...
VALUES 
  ...
  (
    'Felipe Cavalcante de Souza', 
    'UFPR', 
    '2301478'
  ), 
  (
    'Bianca Gonçalves Lima', 
    'UERJ', 
    '7453200'
  ), 
  (
    'Mariana Almeida Araújo', 
    'UFRS', 
    '3698745'
  );

INSERT INTO Pesquisador_Acervo (
  pesquisador_matricula, 
  acervo_id
) 
VALUES 
  ('1236987', 1), 
...
-- Funções
CREATE OR REPLACE FUNCTION obter_documentos_por_autor(
...
CREATE OR REPLACE FUNCTION obter_pesquisadores_por_acervoid(
  id_param INT
) RETURNS TABLE(
  nome VARCHAR(50), 
  tema VARCHAR(50)
...
CREATE OR REPLACE FUNCTION obter_quantidade_documentos_por_tema(
